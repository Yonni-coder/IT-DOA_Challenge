    ...
    <section class="page-hero">
        <div class="container">
            ...
            <p style="max-width: 700px; margin: 1rem auto; color: var(--muted-foreground);">
                <?php echo get_the_excerpt() ?: 'Découvrez toutes les opportunités disponibles'; ?>
            </p>
        </div>
    </section>
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/annonces.css">
<script src="<?php echo get_template_directory_uri(); ?>/js/annonces.js"></script>
