        ...
        <section class="stats reveal">
            <div class="container">
                <div class="stats-grid">
                    <div class="stat-item">
                        <div class="stat-value" data-target="<?php echo esc_attr(get_option('theme_stats_experience', '15')); ?>">0</div>
                        <div style="color: var(--muted-foreground); margin-top: 0.5rem;">Années d'expérience</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value" data-target="<?php echo esc_attr(get_option('theme_stats_projets', '200')); ?>">0</div>
                        <div style="color: var(--muted-foreground); margin-top: 0.5rem;">Projets réalisés</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value" data-target="<?php echo esc_attr(get_option('theme_stats_clients', '50')); ?>">0</div>
                        <div style="color: var(--muted-foreground); margin-top: 0.5rem;">Clients satisfaits</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value"><?php echo esc_html(get_option('theme_stats_support', '24/7')); ?></div>
